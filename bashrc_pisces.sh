...
alias cpbp='cp -v /usr/local/bin/bpp ~/Dropbox/Latest/bpp_pisces.py'
alias cpj='cp -v ~/Research/jedisim/jedimaster.py ~/Dropbox/Latest/jedimaster_pisces.py'
alias cpjedi='cp -v ~/Research/jedisim/jedimaster.py ~/Dropbox/Latest/jedimaster_pisces.py'
alias cpr='cp -v ~/Research/jedisim/run_jedimaster.py ~/Dropbox/Latest/run_jedimaster_pisces.py'
alias cprun='cp -v ~/Research/jedisim/run_jedimaster.py ~/Dropbox/Latest/run_jedimaster_pisces.py'
alias cppath='echo $PWD | pbcopy '
alias cdpath='cd $(pbpaste)'
alias cpw='echo $PWD | pbcopy'
alias ppw='cd $(pbpaste)'
alias cpb='cp -v ~/.bash_profile ~/Dropbox/Latest/bashrc_pisces.sh'
alias cpv='cp -v ~/.vimrc ~/Dropbox/Latest/vimrc_pisces.sh'
alias cpconfa='cp -v ~/.atom/snippets.cson ~/Dropbox/Latest/atom_pisces_snippets.cson; cp -v ~/.atom/keymap.cson ~/Dropbox/Latest/atom_pisces_keymap.cson; cp -v ~/.atom/init.coffee ~/Dropbox/Latest/atom_pisces_init.coffee; cp -v ~/.atom/custom_entries.json ~/Dropbox/Latest/atom_pisces_custom_entries.json;cp -v ~/.atom/custom_entries_bhishan.json ~/Dropbox/Latest/atom_pisces_custom_entries_bhishan.json;'
alias cpconfv='cp -v ~/.vimrc ~/Dropbox/Latest/pisces_vimrc.sh'
alias cpconfg='cp -v ~/.config/geany/snippets.conf ~/Dropbox/Latest/geany_pisces_snippets.conf.sh; cp -v ~/.config/geany/filedefs/filetypes.python  ~/Dropbox/Latest/geany_pisces_filetypes.python.sh'
...
alias cppros='cp -v ~/Dropbox/Prospectus/prospectus/prospectus.tex ~/Dropbox/Latest/prospectus_pisces.tex; cp -v ~/Dropbox/Prospectus/prospectus/prospectus.tex ~/Dropbox/Prospectus/prospectus/good/prospectus_pisces.tex'
